...
import 'package:find_the_words/features/auth/presentation/widgets/end_drawer/debug_alert_dialog.dart';
                              ...
                              MenuItem(
                                ...
                                function: () async {
                                  if (!await launchUrl(Uri.parse(
                                      'https://github.com/Thanasis-Traitsis/find_the_words'))) {
                                    throw Exception(
                                        'Could not launch github page');
                                  }
                                },
                              ),
                              MenuItem(
