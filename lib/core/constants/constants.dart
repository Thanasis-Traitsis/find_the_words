...
// Current Stage Map
const String answeredWords = 'answeredWords';
const String answeredPositions = 'answeredPositions';
const String unavailablePositions = 'unavailablePositions';
const String key = 'key';
const String currentTimer = 'timerOfStage';
...
const String completeStageLevelUpPoints = 'levelUpPoints';
const String completeStageLevelUp = 'levelUp';
